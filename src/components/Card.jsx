    ...
    return (
      <div className=" shadow-xl m-1 rounded-lg lg:hover:scale-105 lg:hover:-translate-y-3 lg:hover:bg-black lg:hover:text-white relative flex flex-col ">
        <Link to={this.props.navigate}>
          <img
            className="w-64 m-2 rounded-[6px] md:w-56 md:h-80 lg:h-72 lg:w-48 "
            src={
              this.props.img
          ...
          <p className="w-64 m-2 md:w-56 lg:w-48 font-poppins text-xs absolute left-2 top-2 text-white flex items-center">
